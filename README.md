...
6. Download the output `solution.txt` under the Explorer view and upload it to [y-carp.github.io/OptimalWordleSolver](https://y-carp.github.io/OptimalWordleSolver/)
